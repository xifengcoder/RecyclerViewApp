...
import com.yxf.recyclerview.R;
import com.yxf.recyclerview.widget.RecyclerView.ItemAnimator.ItemHolderInfo;
 ...
 * documentation</a>.
 * <p>
 * {@link com.yxf.recyclerview.R.attr#layoutManager}
 */
public class RecyclerView extends ViewGroup implements ScrollingView,
        NestedScrollingChild2, NestedScrollingChild3 {

    static final String TAG = "yxf_RecyclerView";
    ...
    public CharSequence getAccessibilityClassName() {
        return "com.yxf.recyclerview.widget.RecyclerView";
    }
    ...
    public final class Recycler {
        ...
        void scrapView(View view) {
            ...
            if (holder.hasAnyOfTheFlags(ViewHolder.FLAG_REMOVED | ViewHolder.FLAG_INVALID)
                ...
                if (DEBUG) {
                    Log.d(TAG, "**** scrapView add to mAttachedScrap, holder: " + holder);
                }
                ...
                if (DEBUG) {
                    Log.d(TAG, "#### scrapView add to mChangedScrap, holder: " + holder);
                }
        ...
        void unscrapView(ViewHolder holder) {
            if (holder.mInChangeScrap) {
                if (DEBUG) {
                    Log.d(TAG, "#### unscrapView remove mChangedScrap, holder: " + holder);
                }
                mChangedScrap.remove(holder);
            } else {
                if (DEBUG) {
                    Log.d(TAG, "**** unscrapView remove mAttachedScrap, holder: " + holder);
                }
        ...
        void clearScrap() {
            if (DEBUG) {
                Log.d(TAG, "****/#### clearScrap clear mAttachedScrap and mChangedScrap");
            }
            mAttachedScrap.clear();
            if (mChangedScrap != null) {
                mChangedScrap.clear();
            ...
            for (int i = count - 1; i >= 0; i--) {
                ...
                if (holder.getItemId() == id && !holder.wasReturnedFromScrap()) {
                    if (type == holder.getItemViewType()) {
                        ...
                        if (DEBUG) {
                            Log.d(TAG, "**** unscrapView remove mAttachedScrap 222, holder: " + holder);
                        }
    ...
    public abstract static class LayoutManager {
         ...
         * {@link com.yxf.recyclerview.R.attr#spanCount}
         * {@link com.yxf.recyclerview.R.attr#reverseLayout}
         * {@link com.yxf.recyclerview.R.attr#stackFromEnd}
         *
